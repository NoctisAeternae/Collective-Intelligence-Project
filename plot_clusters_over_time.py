...
files = [folder + "/cluster_counts_per_frame_post5_seed_%d.csv" % i for i in range(1, 31)]
...
plt.title("Number of opinion clusters over time")
plt.legend()
...
save_path = os.path.join(plots_folder, "clusters_over_time_post5.png")
